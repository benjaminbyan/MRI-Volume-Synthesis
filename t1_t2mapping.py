...
#the code specifically used for T1-weighted to T2-weighted translation and mapping
#essentially, the file directory is modified so that a new translation is learned by a new ensemble of networks
...
Path_Images = "./Generator_Images_T1T2/"
...
#using checkpoints
checkpoint_path = "checkpoints/Train_T1_T2"
